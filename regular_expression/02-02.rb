# 文字列の全検索 (paizaランク C 相当)
# https://paiza.jp/works/mondai/regular_expression/regular_expression__processing_2

puts`dd`.scan /[^ ]+@[^ ]+/


=begin
パターン: 半角スペースを含まない 1 文字以上の文字列の後に、半角記号 @ が続き、その後に半角スペースを含まない 1 文字以上の文字列が続く文字列
