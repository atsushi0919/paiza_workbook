# 2 次元上のいもす法 4 (paizaランク C 相当)
# https://paiza.jp/works/mondai/prefix_sum_problems/prefix_sum_problems__2d_imos_step4
...
2 行目に a_i, b_i, c_i, d_i (1 ≦ i ≦ N) が N 行で与えられます。

5 行 5 列のマスがあり、最初、マスには全て 0 が書かれています。

N 個の長方形領域の左上の座標 (a_i, b_i) と右下の座標 (c_i, d_i) が与えられます。それぞれの範囲に対して、その範囲に含まれるマスに 1 を加算していきます。
